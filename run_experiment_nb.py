...
model2 = models.create_nbmodel(hidden_state_size=hidden_state, lstm_layers=lstm_layers,
                              seq_length=seq_length, recurrent_dropout=0.0, chroma=True)
training_generator = mlClasses.NbDataGenerator(examples, chroma=chroma, augment=True, st = 5)
val_gen = mlClasses.NbDataGenerator(val,chroma=chroma_val,augment=False)
